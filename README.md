...
**Live interactive demo:** https://shivamsharko.github.io/backstage-spotify-support-agent/ — static and precomputed (no API key, no rate limits): drag the risk threshold, inspect every ticket's decision trail, and test the PII/keyword safety layer in-browser.
